...
window.RETAIL_OS_FAQ = [
  ...
  { topic: 'Getting started', q: 'What do you need from me?',
    a: 'Product details and photos, a pickup address, business and GST details, a WhatsApp number and Meta access. I ask for each one when that part of the build needs it.',
  ...
  { topic: 'Who does what', q: 'What does DevShop do?', visual: 'connectors',
    a: 'The store, hosting and tech, and all connections: payments, shipping, Meta, WhatsApp and Google. I also run marketing, content and reporting.',
  ...
  { topic: 'Ads & Meta', q: 'Do the ads run on their own?', visual: 'metaDaily',
    a: 'Yes. My system is connected to Meta and handles scheduling and running campaigns. I agree the budget and the target return with you. You do not need to open Ads Manager.',
  ...
  { topic: 'Content', q: 'Do I need a photoshoot?', visual: 'imageGen',
    a: 'Usually not. From one product photo I generate model shots, lifestyle images and short videos.',
  ...
  { topic: 'Store & catalog', q: 'I am on WooCommerce or something else.',
    a: 'I import from a spreadsheet or from what you send me, and use your past order data for ads.',
