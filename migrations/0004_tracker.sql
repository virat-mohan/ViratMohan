...
-- tracking for the 15-day guarantee, and a weekly update log for the
...
alter table submissions add column if not exists delivery_deadline timestamptz; -- deposit_paid_at + 15 days; the guarantee clock
