...
- 26 Sep, Employee Support Agent: team questions used to go only to Virat, so a new hire waited on him for things the Brain already knew. Rule: a team question gets a sourced Brain answer by email first; only unanswered ones nudge Virat, and both land in the 9:30 team report.
