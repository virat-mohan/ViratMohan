...
- 2026-09-26: Brand work was scattered across Gmail, Supabase and the ops board with no single record. Each brand now gets one file in `case-study/brands/` that cites where every fact came from.
