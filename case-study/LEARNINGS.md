...
- 2026-09-26: The Brain only knew 10 files; CLAUDE.md, WOW-TARGETS, the SCS voice notes and the DevShop verticals never reached it. The seed now harvests every house doc line by line and warns on any case-study/*.md it does not read, so a new doc can't be silently missed.
