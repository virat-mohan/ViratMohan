...
export const POST: APIRoute = async ({ request }) => {
  let body: { planId?: string; applicationId?: string; ordersM1?: number; ordersM2?: number; ordersM3?: number; aovInr?: number; cogsPct?: number; cacPct?: number; adminTechPct?: number };
  try {
